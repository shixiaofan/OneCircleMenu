...
{
    private int mRadius;//该容器
    private static final float RADIO_DEFAULT_CHILD_DIMENSION=1/4f;  //该容器内child item的默认尺寸
    private float RADIO_DEFAULT_CENTERITEM_DIMENSION=1/3f;   //菜单中心的尺寸
    private static final float RADIO_PADDING_LAYOUT=1/12f;  //容器内边距，无视padding属性
